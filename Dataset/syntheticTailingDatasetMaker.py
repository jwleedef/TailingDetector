...
def makeTailingSituation(quadrant, w, h, numberOfMaxPerson):
    ...
    if quadrant == 1:
        ...
        if direction == 1:
            for s in range(10):
                gridMap[s, init_x[0] + (s * horizontal), init_y[0]] = 1
                gridMap[s, init_x[1] + (s * horizontal), init_y[1]] = 1
        elif direction == 2:
            for s in range(10):
                gridMap[s, init_x[0], init_y[0] + (s * vertical)] = 1
                gridMap[s, init_x[1], init_y[1] + (s * vertical)] = 1
        elif direction == 3:
            for s in range(10):
                gridMap[s, init_x[0] + (s * horizontal), init_y[0] + (s * vertical)] = 1
                gridMap[s, init_x[1] + (s * horizontal), init_y[1] + (s * vertical)] = 1
...
if __name__ == '__main__':
    ...
    if type == 'valid': # Tailing Situation
        for i in range(numberOfData):
            ...
            gridMap = makeTailingSituation(quadrant, w, h, numberOfMaxPerson)
